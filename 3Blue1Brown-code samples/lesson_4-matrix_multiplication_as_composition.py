...
"""
In previous lesson I learned how to multiply matricies by vectors and what linear transformation is

But we can apply 2 or 3 or more of such transformations
There's example (see illustrations/lesson4-matrix_compositioning_example(2 space transformations).png)

It's really cool!

But as we're representing our i and j coordinates as Matrix
We can easily find out how to multiply matricies:

1. Multiply first column of right matrix (yeah we calculate them from right to left as it's like function unwrapping)
by left matrix (left from rightest). (It's easy tho as we've seen it in lesson 3)

congrats! It will be your first column of new "Composition" matrix

2. Multiply 2nd column by left matrix. Congrats! It will be your second column of new matrix

3, 4, 5, ... , n.  Multiply nth column by left matrix. Congrats! It will be your nth column of new matrix

But the last step is more for CS cus now we talk about i and j (only 2)
Where:

1st col: i basis vector coordinates
2nd col: j basis vector coordinates

And yeah... order makes sense!!!
M1M2 != M2M1
"""
...
class VectorSum(Scene):
    def construct(self):
        ...
        text = Text("""Vectors are summed up
                    by ''Triangle'' rule""")
        self.play(Write(text))


# python -m manim lesson_4-matrix_multiplication_as_composition.py PlaneComposition